<?php
// source: /Applications/MAMP/htdocs/sandbox/app/config/common.neon
// source: /Applications/MAMP/htdocs/sandbox/app/config/local.neon
// source: array
...
class Container_2f705908d1 extends Nette\DI\Container
{
	protected $tags = [
		'nette.inject' => [
			'application.1' => true,
	...
	protected $wiring = [
		...
		'App\Presenters\BooksPresenter' => [2 => ['application.1']],
		'App\Presenters\ErrorPresenter' => [2 => ['application.2']],
		'App\Presenters\ApiPresenter' => [2 => ['application.3']],
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => '/Applications/MAMP/htdocs/sandbox/app',
			'wwwDir' => '/Applications/MAMP/htdocs/sandbox/www',
			'vendorDir' => '/Applications/MAMP/htdocs/sandbox/vendor',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => '/Applications/MAMP/htdocs/sandbox/app/../temp',
		];
	}


	public function createServiceApplication__1(): App\Presenters\BooksPresenter
	{
	...
	public function createServiceApplication__3(): App\Presenters\ApiPresenter
	{
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, '/Applications/MAMP/htdocs/sandbox/app/../temp/cache/nette.application/touch'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('/Applications/MAMP/htdocs/sandbox/app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/Applications/MAMP/htdocs/sandbox/app/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}


	public function createServiceContainer(): Container_2f705908d1
	{
		return $this;
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_2f705908d1 $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('/Applications/MAMP/htdocs/sandbox/app/../temp/cache/latte');
